...
time ./src/fit_bpe.py $GLOBAL_PARAMS -vo computed/small/greedy_beamsearch_v${VOCAB_SIZE}_l2k_new.bpe_merges -m greedy_beamsearch_new --beam-n 3
...
for LANG in "en" "de"; do
    ...
    BPECODES="computed/small/greedy_beamsearch_v1024_l2k_new.bpe_merges"
    ./src/apply_bpe.py $GLOBAL_PARAMS_APPLY \
        --method ${METHOD} \
        --vocab-input ${BPECODES} \
        --input "data/CCrawl.de-en/train.tok.${LANG}" \
