...
for TRAIN_LINES in "400000" "100000" "25000" "5000"; do
    ...
    #             --process-output \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/dev.tok.en \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/dev.tok.de \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/test.tok.en \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/test.tok.de \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/train.tok.en \
    #                     data/model_tokenizer_${TOKENIZER_METHOD}/${TRAIN_LINES_NAME}/train.tok.de \
    #         ";
    #     done
done
