...
plt.title(
    r"$\mathrm{H}" +f"={h_0:.2f}, " + r"\mathrm{H}" + f"_1={h_1:.2f}, " + r"\mathrm{H}" + f"_9 ={h_3:.2f}$\n$" + r"\mathrm{H}_1/\mathrm{H}"+ f"_0={h_1/h_0:.0%}$," r" $\mathrm{H}_{9}/\mathrm{H}" f"_0={h_3/h_0:.0%}$".replace("%", r"\%"),
